    ...
    function getDetails(url_pokemon){
        ...
        .then(function(response){
               console.log(response)
                ...
                modal = `<div class="modal fade" id="modal_${response.name}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#divsubmodal__${response.name}">
                  ...
                  modal2 = `<div class="modal fade" id="divsubmodal__${response.name}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">${response.name}</h5>
                ...
                $("divsubmodal__"+(response.name)).append(modal2)
            })
    }
